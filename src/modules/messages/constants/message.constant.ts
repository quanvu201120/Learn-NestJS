export const MESSAGE_MESSAGES = {
    ...
    CANNOT_DELETE_USER_HIDDEN: 'User has deleted conversation, can not delete message',
    NOT_BELONG_TO_CONVERSATION: 'Message not found or message not belong to this conversation',
    NOT_MESSAGE_OWNER: 'User is not owner of this message',
