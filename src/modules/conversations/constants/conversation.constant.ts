export const CONVERSATION_MESSAGES = {
    ...
    GROUP_MIN_3_USERS: 'Group conversation must have at least 3 users including creator',
    USERS_NOT_EXIST: 'One or more users do not exist',
    USER_NOT_FOUND: 'User not found',
    NAME_REQUIRED: 'Name is required',
    CANNOT_REMOVE_SELF: 'Cannot remove yourself from conversation',
    ...
    DIRECT_ACTION_NOT_ALLOWED: 'Cannot perform this action on direct conversation',
